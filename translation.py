...
URL | filename | username | password"""
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = "Thanks for using @url_downloder12_bot\n\n<b>Join : @UrlUploder14_bot</b>"
...
If bot didn't respond, contact @Bangla_And_Hindi_Movie"""
